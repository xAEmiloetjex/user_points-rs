...
// Add relations
    ...
    amber.new_relation("sammi");

// Set HATE points
    amber.set_points  ("key", PT::HATE, 0.69);
    amber.set_points  ("dark", PT::HATE, 0.0);
    amber.set_points  ("ephy", PT::HATE, (utils::MAX_FLOAT - 3.0) + 0.1);
